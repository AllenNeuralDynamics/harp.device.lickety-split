...
namespace AllenNeuralDynamics.LicketySplit
{
    ...
    public partial class Device : Bonsai.Harp.Device, INamedElement
    {
        ...
        /// <summary>
        /// Gets the contents of the metadata file describing the <see cref="LicketySplit"/>
        /// device registers.
        /// </summary>
    ...
    /// describing the <see cref="LicketySplit"/> device registers.
    /// </summary>
    [Description("Returns the contents of the metadata file describing the LicketySplit device registers.")]
